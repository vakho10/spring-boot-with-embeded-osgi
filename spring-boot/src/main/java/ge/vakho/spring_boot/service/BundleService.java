...
public class BundleService {
	...
	@Autowired
	public BundleService(BundleConfigFile bundleConfigFile, BundleContext bundleContext, BundleProperties bundleProperties, BundleInstallService bundleInstallService, BundleCleanupService bundleCleanupService) {
